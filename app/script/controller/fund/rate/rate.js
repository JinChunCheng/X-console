define([], function() {
    return ['$scope', '$http','metaService','$filter', '$timeout', '$modal', '$state', 'borrowerService',
        function($scope, $http,metaService,$filter, $timeout, $modal, $state, borrowerService) {
            ...
            $scope.listVM = {
                ...
                rateCode:[{id:1,title:'充值'},{id:2,title:'提现'}],
